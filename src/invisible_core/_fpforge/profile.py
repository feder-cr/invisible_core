...
# L|v0|v1|...     - DirectWrite grayscale coverage ladder (17 alpha levels).
#   The glyph-edge coverage a Windows Firefox produces. FreeType uses the
#   whole 8-bit range (193-256 levels per render against 9-19 on Windows),
#   which is a STRUCTURAL tell a detector can read by counting. Snapping the
#   alpha to this ladder keeps the real glyph shape and removes the count.
...
#   a bare U+2764 measured 31.77 on Windows and 40.03 on Linux.
